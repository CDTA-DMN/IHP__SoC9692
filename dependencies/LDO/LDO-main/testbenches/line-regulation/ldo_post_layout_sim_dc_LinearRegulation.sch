...
N -290 60 -10 60 {lab=VLDO}
N -100 120 -100 220 {lab=GND}
N -180 220 -180 230 {lab=GND}
N -180 220 -100 220 {lab=GND}
N -180 120 -180 220 {lab=GND}
C {lab_pin.sym} -10 20 0 0 {name=p1 sig_type=std_logic lab=VBGR}
C {lab_pin.sym} -10 0 0 0 {name=p3 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -290 60 2 1 {name=p2 sig_type=std_logic lab=VLDO}
...
C {code_shown.sym} -100 -80 2 1 {name=s1 only_toplevel=false value=" 
.control
save all
op 
...
C {capa.sym} -180 90 0 0 {name=C1
m=1
value=100p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -180 230 0 0 {name=l8 lab=GND}
C {res.sym} -100 90 0 0 {name=R4
value=6k
footprint=1206
device=resistor
m=1}
