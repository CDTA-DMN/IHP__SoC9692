...
N -110 40 -110 140 {lab=GND}
N -190 140 -190 150 {lab=GND}
N -190 140 -110 140 {lab=GND}
N -190 40 -190 140 {lab=GND}
N -250 -20 -40 -20 {lab=VLDO}
...
C {simulator_commands_shown.sym} 80 -320 0 0 {
name=Libs_Ngspice
simulator=ngspice
only_toplevel=false
value="
...
C {lab_pin.sym} -40 -60 0 0 {name=p1 sig_type=std_logic lab=VBGR}
C {lab_pin.sym} -40 -80 0 0 {name=p3 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -250 -20 2 1 {name=p2 sig_type=std_logic lab=VLDO}
C {lab_pin.sym} -40 -40 0 0 {name=p4 sig_type=std_logic lab=VDD}
C {/foss/designs/simulations/LDO/LDO.sym} -20 -90 0 0 {name=X1}
C {capa.sym} -190 10 0 0 {name=C1
m=1
value=100p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -190 150 0 0 {name=l8 lab=GND}
C {res.sym} -110 10 0 0 {name=R4
value=6k
footprint=1206
device=resistor
m=1}
C {code_shown.sym} -240 -180 2 1 {name=s1 only_toplevel=false value=" 
.temp 125
.control
save all
op 
