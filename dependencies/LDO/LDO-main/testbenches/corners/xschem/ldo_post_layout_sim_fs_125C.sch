...
N -90 30 -90 130 {lab=GND}
N -170 130 -170 140 {lab=GND}
N -170 130 -90 130 {lab=GND}
N -170 30 -170 130 {lab=GND}
...
C {capa.sym} -170 0 0 0 {name=C1
m=1
value=100p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -170 140 0 0 {name=l8 lab=GND}
C {res.sym} -90 0 0 0 {name=R4
value=6k
footprint=1206
device=resistor
m=1}
C {code_shown.sym} -230 -210 2 1 {name=s1 only_toplevel=false value=" 
.temp 125
.control
save all
op 
