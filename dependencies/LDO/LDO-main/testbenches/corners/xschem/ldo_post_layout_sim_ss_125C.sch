...
N -100 50 -100 150 {lab=GND}
N -180 150 -180 160 {lab=GND}
N -180 150 -100 150 {lab=GND}
N -180 50 -180 150 {lab=GND}
N -240 -10 -30 -10 {lab=VLDO}
...
C {simulator_commands_shown.sym} 110 -350 0 0 {
name=Libs_Ngspice
simulator=ngspice
only_toplevel=false
value="
...
C {lab_pin.sym} -30 -50 0 0 {name=p1 sig_type=std_logic lab=VBGR}
C {lab_pin.sym} -30 -70 0 0 {name=p3 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -240 -10 2 1 {name=p2 sig_type=std_logic lab=VLDO}
C {lab_pin.sym} -30 -30 0 0 {name=p4 sig_type=std_logic lab=VDD}
C {/foss/designs/simulations/LDO/LDO.sym} -10 -80 0 0 {name=X1}
C {capa.sym} -180 20 0 0 {name=C1
m=1
value=100p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} -180 160 0 0 {name=l8 lab=GND}
C {res.sym} -100 20 0 0 {name=R4
value=6k
footprint=1206
device=resistor
m=1}
C {code_shown.sym} -170 -210 2 1 {name=s1 only_toplevel=false value=" 
.temp 125
.control
save all
op 
